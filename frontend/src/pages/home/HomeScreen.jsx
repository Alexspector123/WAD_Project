...
import { MOVIE_CATEGORIES, TV_CATEGORIES, ORIGINAL_IMG_BASE_URL } from '../../utils/constant.js';
  ...
  return (
    <>
      <div className='relative h-screen text-white bg-black'>
        ...
        <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 motion-reduce:px-16'>
      ...
      <div className='flex flex-col gap-[10px] bg-black py-[10px]'>
        {contentType === 'movie'
